...
var App = (function (_super) {
    ...
    Object.defineProperty(App.prototype, "bindPoint", {
        get: function () {
    ...
    App.prototype.getPoint = function (ev) {
    ...
    App.prototype.drawLine = function (p1, p2) {
    ...
    App.prototype.lerp = function (x0, y0, x1, y1, x) {
        return y0 + (y1 - y0) * (x - x0) / (x1 - x0);
    };
    App.prototype.convert = function (p) {
        //startPointとbindPointを結ぶ直線
        var p1 = this.startPoint;
        var p2 = this.bindPoint;
        var x = p.x;
        var y = this.lerp(p1.x, p1.y, p2.x, p2.y, x);
        return { x: x, y: y };
    };
